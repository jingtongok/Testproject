package com.mosi.uikit.recycleview;
...
import com.mosi.utils.UIdpUtils;
...
public class PowerfulRecyclerView extends RecyclerView {
    ...
    public PowerfulRecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        mDividerSize = ta.getDimensionPixelSize(R.styleable.PowerfulRecyclerView_dividerSize, UIdpUtils.dip2Px(context,1));
