...
import com.mosi.utils.NetWorkUtils;
...
//        long duration = endTime - startTime;
        ...
        Log.e("mosi", "---------- Request Start----------------");
        Log.e("mosi", "| " + request.toString());
        Log.e("mosi", "| Response:" + content);
        Log.e("mosi", "---------- Request End ----------------");
    ...
    public ApiRetrofit() {
        ...
        mRetrofit = new Retrofit.Builder()
                .baseUrl("http://47.94.237.74:9790/")
